...
export default function FritzPage() {
  ...
  return (
    <>
      <Head>
        <title>LocalHorst V9 | Fritz Box</title>
      </Head>
      <SectionCard title="Fritz Box">
        <h1 className="py-4 text-2xl">
          Wann wurde die Fritz!Box hergestellt / produziert?
        </h1>
        <p className="py-2">
        ...
        <div className="grid grid-cols-2 gap-10">
          <Card className="w-full">
            <CardHeader>
              <CardTitle>Hier Seriennummer eingeben</CardTitle>
              <CardDescription>
          ...
          <Card className="w-full">
            <CardHeader>
              <CardTitle>Produktionsdatum</CardTitle>
              <CardDescription>Heute ist {today}</CardDescription>
            </CardHeader>
            <CardContent>
              {Warranty == null && (
            ...
            <CardFooter>
              Herstellungedatum: {WarrantyDate} - Laut AVM Algo. (Alle Angaben
              ohne Gewähr)
            </CardFooter>
          </Card>
        </div>
